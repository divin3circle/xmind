  ...
  return (
    <div className="w-full max-w-5xl">
      <div className="relative border-l border-dashed border-muted-foreground/30 pl-6 ml-4 space-y-8 pb-4">
        {logs.map((log) => (
          <div key={log._id?.toString() || Math.random().toString()} className="relative">
            {/* Timeline node */}
            ...
            <div className="flex flex-col border border-dashed p-4 hover:bg-muted/5 transition-colors">
              ...
              <div className="text-sm font-sans text-muted-foreground mb-4 whitespace-pre-wrap leading-relaxed">
                {log.reasoning}
              </div>
              ...
              {log.txHash && (
                <a
                  ...
                  className="flex items-center text-[11px] font-mono text-blue-400 hover:text-blue-300 transition-colors bg-blue-500/10 self-start px-2 py-1 rounded-sm border border-blue-500/20"
                >
