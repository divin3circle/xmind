    ...
    <section className="my-24">
      <div className="py-8 mx-4 border mt-8 relative border-dashed px-4">
        ...
        <div className="flex items-center justify-between flex-col md:flex-row mt-4">
          <Input
            className="w-full font-mono md:w-1/4 h-10"
            placeholder="Search agents"
          />
          <div className="mt-4 md:mt-0 font-mono text-xs text-muted-foreground flex items-center justify-between w-full md:w-auto">
            <Button
              variant="outline"
