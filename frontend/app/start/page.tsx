  ...
  return (
    <div className="max-w-7xl relative mx-auto my-0 flex items-center h-screen w-screen justify-center">
      <div className="mx-4 border mt-8 relative border-dashed p-4 min-w-sm">
        ...
        <p className="my-8 text-xs text-muted-foreground font-sans font-semibold text-center">
          Or Continue with
        </p>
        <div className="mt-8 flex flex-col gap-4 mb-4">
          <Button
            className=" w-full flex h-8 text-muted-foreground font-semibold border-green-500 border-dashed font-sans"
            variant="outline"
          >
